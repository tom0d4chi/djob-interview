...
export default function SelectCategory({categories, handleCategoryChange}: SelectCategoryProps){
    return (
        ...
        <select className="rounded-full focus:outline-[0px] h-full px-4 w-full bg-[#1e1e1e] border-0  text-white pl-0" name="category" onChange={e => handleCategoryChange(e.target.value)}>
